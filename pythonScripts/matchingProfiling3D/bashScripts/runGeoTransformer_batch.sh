...
echo "Starting GeoTransformer batch processing..."
echo "=============================================="
echo "Config: $CONFIG"
...
for noise_level in low_gauss high_gauss low_salt_pepper high_salt_pepper None low high; do
    for data_type in val train; do
        ...
        OUTPUT_FILE="outputFiles/geotransformer/outfile_geotransformer_${noise_level}_${data_type}.csv"
...
echo ""
echo "=============================================="
echo "GeoTransformer batch processing complete!"
echo "=============================================="
