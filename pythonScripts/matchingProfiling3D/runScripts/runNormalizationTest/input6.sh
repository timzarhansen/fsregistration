...
./testingSoftOnPredatorData.py configFiles/predatorNothing.yaml 32 1 4 28 0.001 0.1 0 & >/dev/null 2>&1
pid1=$!
./testingSoftOnPredatorData.py configFiles/predatorNothing.yaml 64 1 8 56 0.001 0.1 1 & >/dev/null 2>&1
pid2=$!
