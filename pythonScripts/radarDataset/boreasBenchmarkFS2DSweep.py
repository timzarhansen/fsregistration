"""
FS2D Parameter Sweep Benchmark

Tests all combinations of configurable FS2D parameters on a single Boreas
...
Usage:
    # Just run with the CONFIG at the top of this file
    python boreasBenchmarkFS2DSweep.py
"""
...
PARAM_GRID = {
    # "N": [64,128],
    # "radius": [140.0,165.0,115.0],
    # "matching_step": [3,5],
    # "potential_for_necessary_peak": [0.1],
    ...
    "radius": [140.0,165.0,115.0],
    "matching_step": [3],
    "potential_for_necessary_peak": [0.1, 0.01],
    "level_potential_rotation": [ 0.001, 0.0001],
    "use_direct": [True],
    "use_clahe": [False,True],
    "use_hamming": [True,False],
    "multiple_radii": [True],
    "use_gauss": [False],
    "normalization": [0,1],
    "use_weighted_peak_score": [True,False],
    "use_phase_correlation": [False,True],
    "round": [False,True],
}
# ============================================================================
...
PARAM_ABBREV = {
    "potential_for_necessary_peak": "pk",
    "level_potential_rotation": "rot",
    "use_direct": "dir",
    "round": "mask",
    "radius": "R",
    "normalization": "norm",
    "use_phase_correlation": "pc",
    "use_clahe": "cla",
    "use_hamming": "ham",
    "multiple_radii": "mr",
    "use_gauss": "gau",
    "use_weighted_peak_score": "ws",
    "matching_step": "step",
    "N": "N",
}
...
def build_output_name(combo: dict, varied_keys: List[str], N: int,
    ...
    parts = [f"seq{SEQUENCE:02d}_fs2d_N{N:03d}_p{int(size_of_pixel * 100):04d}{s_part}"]
...
# ============================================================================
# Single-combo runner (can run in a worker process)
# ============================================================================
...
def run_single_combo(args: tuple) -> Tuple[str, dict]:
    ...
    method_config = {
        ...
        "use_hamming": combo["use_hamming"],
        "potential_for_necessary_peak": combo["potential_for_necessary_peak"],
        "level_potential_rotation": combo["level_potential_rotation"],
        "multiple_radii": combo["multiple_radii"],
        "use_gauss": combo["use_gauss"],
        "use_direct": combo["use_direct"],
        "normalization": combo["normalization"],
        "use_weighted_peak_score": combo["use_weighted_peak_score"],
        "use_phase_correlation": combo["use_phase_correlation"],
    }
    ...
    for pair_idx in range(num_pairs):
        ...
        try:
            ...
            for sol in all_solutions:
                ...
                s_tx = sol_affine[0, 2]
                s_ty = sol_affine[1, 2]
                if abs(s_rot_err) < abs(best_rot_error) or \
                   (abs(s_rot_err) == abs(best_rot_error) and s_trans_norm < best_trans_error):
    ...
    # Save results.csv (same format as boreasBenchmark.py)
...
def main():
    ...
    print("=" * 75)
    print("FS2D Parameter Sweep Benchmark")
    print("=" * 75)
