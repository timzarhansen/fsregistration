"""
KAZE Parameter Sweep Benchmark

Tests all combinations of configurable KAZE parameters on a single Boreas
...
Usage:
    python boreasBenchmarkKAZESweep.py
"""
...
PARAM_GRID = {
    ...
    "radius": [140.0],
    "matching_step": [3],
    "kaze_threshold": [0.0001, 0.001, 0.01],
    "kaze_n_octaves": [4],
    ...
    "kaze_ransac_threshold": [0.5, 1.0, 3.0],
...
PARAM_ABBREV = {
    "kaze_threshold": "thr",
    "kaze_n_octaves": "oct",
    "kaze_n_octave_layers": "lay",
    "kaze_diffusivity": "diff",
    "kaze_upright": "up",
    "kaze_extended": "ext",
    "kaze_ratio_threshold": "rt",
    "kaze_ransac_threshold": "rth",
    "kaze_ransac_confidence": "rcf",
    "round": "mask",
    "radius": "R",
    "matching_step": "step",
    "N": "N",
...
def build_output_name(combo: dict, varied_keys: List[str], N: int,
    ...
    parts = [f"seq{SEQUENCE:02d}_kaze_N{N:03d}_p{int(size_of_pixel * 100):04d}{s_part}"]
...
def run_single_combo(args: tuple) -> Tuple[str, dict]:
    ...
    method_config = {
        ...
        "kaze_threshold": combo["kaze_threshold"],
        "kaze_n_octaves": combo["kaze_n_octaves"],
        "kaze_n_octave_layers": combo["kaze_n_octave_layers"],
        "kaze_diffusivity": combo["kaze_diffusivity"],
        "kaze_upright": combo["kaze_upright"],
        "kaze_extended": combo["kaze_extended"],
        "kaze_ratio_threshold": combo["kaze_ratio_threshold"],
        "kaze_ransac_threshold": combo["kaze_ransac_threshold"],
        "kaze_ransac_confidence": combo["kaze_ransac_confidence"],
    }
    ...
    method = RegistrationFactory.create("kaze", method_config)
...
def main():
    ...
    print("=" * 75)
    print("KAZE Parameter Sweep Benchmark")
    print("=" * 75)
