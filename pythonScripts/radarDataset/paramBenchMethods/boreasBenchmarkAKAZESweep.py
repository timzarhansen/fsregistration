"""
AKAZE Parameter Sweep Benchmark

Tests all combinations of configurable AKAZE parameters on a single Boreas
...
Usage:
    python boreasBenchmarkAKAZESweep.py
"""
...
PARAM_ABBREV = {
    "akaze_descriptor_type": "desc",
    "akaze_descriptor_size": "dsz",
    "akaze_descriptor_channels": "dch",
    "akaze_threshold": "thr",
    "akaze_n_octaves": "oct",
    "akaze_n_octave_layers": "lay",
    "akaze_diffusivity": "diff",
    "akaze_ratio_threshold": "rt",
    "akaze_ransac_threshold": "rth",
    "akaze_ransac_confidence": "rcf",
    "round": "mask",
    "radius": "R",
    "matching_step": "step",
    "N": "N",
...
def build_output_name(combo: dict, varied_keys: List[str], N: int,
    ...
    parts = [f"seq{SEQUENCE:02d}_akaze_N{N:03d}_p{int(size_of_pixel * 100):04d}{s_part}"]
...
def run_single_combo(args: tuple) -> Tuple[str, dict]:
    ...
    method_config = {
        ...
        "akaze_descriptor_type": combo["akaze_descriptor_type"],
        "akaze_descriptor_size": combo["akaze_descriptor_size"],
        "akaze_descriptor_channels": combo["akaze_descriptor_channels"],
        "akaze_threshold": combo["akaze_threshold"],
        "akaze_n_octaves": combo["akaze_n_octaves"],
        "akaze_n_octave_layers": combo["akaze_n_octave_layers"],
        "akaze_diffusivity": combo["akaze_diffusivity"],
        "akaze_ratio_threshold": combo["akaze_ratio_threshold"],
        "akaze_ransac_threshold": combo["akaze_ransac_threshold"],
        "akaze_ransac_confidence": combo["akaze_ransac_confidence"],
    }
    ...
    method = RegistrationFactory.create("akaze", method_config)
...
def main():
    ...
    print("=" * 75)
    print("AKAZE Parameter Sweep Benchmark")
    print("=" * 75)
