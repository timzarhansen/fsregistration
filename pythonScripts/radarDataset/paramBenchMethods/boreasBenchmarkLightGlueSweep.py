"""
LightGlue Parameter Sweep Benchmark

Tests all combinations of configurable LightGlue parameters on a single
Boreas sequence (default: seq 0). Each combination gets its own output
subdirectory with results.csv and config.json.

Usage:
    python boreasBenchmarkLightGlueSweep.py
"""
...
PARAM_ABBREV = {
    "lightglue_features": "feat",
    "lightglue_max_num_keypoints": "kp",
    "lightglue_depth_confidence": "depth",
    "lightglue_width_confidence": "width",
    "lightglue_filter_threshold": "filt",
    "lightglue_ransac_threshold": "rth",
    "lightglue_ransac_confidence": "rcf",
    "round": "mask",
    "radius": "R",
    "matching_step": "step",
    "N": "N",
...
def build_output_name(combo: dict, varied_keys: List[str], N: int,
    ...
    parts = [f"seq{SEQUENCE:02d}_lightglue_N{N:03d}_p{int(size_of_pixel * 100):04d}{s_part}"]
...
def run_single_combo(args: tuple) -> Tuple[str, dict]:
    ...
    method_config = {
        ...
        "lightglue_features": combo["lightglue_features"],
        "lightglue_max_num_keypoints": combo["lightglue_max_num_keypoints"],
        "lightglue_depth_confidence": combo["lightglue_depth_confidence"],
        "lightglue_width_confidence": combo["lightglue_width_confidence"],
        "lightglue_filter_threshold": combo["lightglue_filter_threshold"],
        "lightglue_ransac_threshold": combo["lightglue_ransac_threshold"],
        "lightglue_ransac_confidence": combo["lightglue_ransac_confidence"],
    }
    ...
    method = RegistrationFactory.create("lightglue", method_config)
...
def main():
    ...
    print("=" * 75)
    print("LightGlue Parameter Sweep Benchmark")
    print("=" * 75)
