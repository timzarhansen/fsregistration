"""
LoFTR Parameter Sweep Benchmark

Tests all combinations of configurable LoFTR parameters on a single Boreas
...
Usage:
    python boreasBenchmarkLoFTRSweep.py
"""
...
PARAM_GRID = {
    ...
    "radius": [140.0],
    "matching_step": [3],
    "loftr_ransac_threshold": [1.0, 3.0, 5.0],
...
PARAM_ABBREV = {
    "loftr_ransac_threshold": "rth",
    "loftr_ransac_confidence": "rcf",
    "round": "mask",
    "radius": "R",
    "matching_step": "step",
    "N": "N",
...
def build_output_name(combo: dict, varied_keys: List[str], N: int,
    ...
    parts = [f"seq{SEQUENCE:02d}_loftr_N{N:03d}_p{int(size_of_pixel * 100):04d}{s_part}"]
...
def run_single_combo(args: tuple) -> Tuple[str, dict]:
    ...
    method_config = {
        ...
        "loftr_ransac_threshold": combo["loftr_ransac_threshold"],
        "loftr_ransac_confidence": combo["loftr_ransac_confidence"],
    }
    ...
    method = RegistrationFactory.create("loftr", method_config)
...
def main():
    ...
    print("=" * 75)
    print("LoFTR Parameter Sweep Benchmark")
    print("=" * 75)
