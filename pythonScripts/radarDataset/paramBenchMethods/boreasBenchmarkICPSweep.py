"""
ICP Parameter Sweep Benchmark

Tests all combinations of configurable ICP parameters on a single Boreas
...
Usage:
    python boreasBenchmarkICPSweep.py
"""
...
PARAM_ABBREV = {
    "icp_max_distance": "dmax",
    "icp_max_iteration": "iter",
    "icp_scale": "scl",
    "icp_threshold_pct": "thr",
    "icp_voxel_size": "vox",
    "round": "mask",
    "radius": "R",
    "matching_step": "step",
...
def build_output_name(combo: dict, varied_keys: List[str], N: int,
    ...
    parts = [f"seq{SEQUENCE:02d}_icp_N{N:03d}_p{int(size_of_pixel * 100):04d}{s_part}"]
...
def run_single_combo(args: tuple) -> Tuple[str, dict]:
    ...
    method_config = {
        ...
        "icp_max_distance": combo["icp_max_distance"],
        "icp_max_iteration": combo["icp_max_iteration"],
        "icp_scale": combo["icp_scale"],
        "icp_threshold_pct": combo["icp_threshold_pct"],
        "icp_voxel_size": combo["icp_voxel_size"],
    ...
    method = RegistrationFactory.create("icp", method_config)
...
def main():
    ...
    print("=" * 75)
    print("ICP Parameter Sweep Benchmark")
    print("=" * 75)
