"""
SIFT Parameter Sweep Benchmark

Tests all combinations of configurable SIFT parameters on a single Boreas
...
Usage:
    python boreasBenchmarkSIFTSweep.py
"""
...
PARAM_GRID = {
    ...
    "sift_contrast_threshold": [0.01, 0.02, 0.04, 0.08],
    "sift_edge_threshold": [10],
    "sift_sigma": [1.6],
    "sift_ratio_threshold": [0.75],
    "sift_ransac_threshold": [0.5, 1.0, 3.0, 5.0],
...
PARAM_ABBREV = {
    "sift_nfeatures": "nf",
    "sift_n_octave_layers": "oct",
    "sift_contrast_threshold": "cth",
    "sift_edge_threshold": "eth",
    "sift_sigma": "sig",
    "sift_ratio_threshold": "rt",
    "sift_ransac_threshold": "rth",
    "sift_ransac_confidence": "rcf",
    "round": "mask",
    "radius": "R",
    "matching_step": "step",
    "N": "N",
...
def build_output_name(combo: dict, varied_keys: List[str], N: int,
    ...
    parts = [f"seq{SEQUENCE:02d}_sift_N{N:03d}_p{int(size_of_pixel * 100):04d}{s_part}"]
...
def run_single_combo(args: tuple) -> Tuple[str, dict]:
    ...
    method_config = {
        ...
        "sift_nfeatures": combo["sift_nfeatures"],
        "sift_n_octave_layers": combo["sift_n_octave_layers"],
        "sift_contrast_threshold": combo["sift_contrast_threshold"],
        "sift_edge_threshold": combo["sift_edge_threshold"],
        "sift_sigma": combo["sift_sigma"],
        "sift_ratio_threshold": combo["sift_ratio_threshold"],
        "sift_ransac_threshold": combo["sift_ransac_threshold"],
        "sift_ransac_confidence": combo["sift_ransac_confidence"],
    }
    ...
    method = RegistrationFactory.create("sift", method_config)
...
def main():
    ...
    print("=" * 75)
    print("SIFT Parameter Sweep Benchmark")
    print("=" * 75)
