"""
SURF Parameter Sweep Benchmark

Tests all combinations of configurable SURF parameters on a single Boreas
...
Usage:
    python boreasBenchmarkSURFSweep.py
"""
...
PARAM_GRID = {
    ...
    "radius": [140.0],
    "matching_step": [3],
    "surf_hessian_threshold": [100, 400, 1000],
    "surf_n_octaves": [4],
    "surf_n_octave_layers": [3],
    "surf_extended": [True],
    "surf_upright": [False, True],
    "surf_ratio_threshold": [0.75],
    "surf_ransac_threshold": [0.5, 1.0, 3.0, 5.0],
...
PARAM_ABBREV = {
    "surf_hessian_threshold": "hess",
    "surf_n_octaves": "oct",
    "surf_n_octave_layers": "lay",
    "surf_extended": "ext",
    "surf_upright": "up",
    "surf_ratio_threshold": "rt",
    "surf_ransac_threshold": "rth",
    "surf_ransac_confidence": "rcf",
    "round": "mask",
    "radius": "R",
    "matching_step": "step",
    "N": "N",
...
def build_output_name(combo: dict, varied_keys: List[str], N: int,
    ...
    parts = [f"seq{SEQUENCE:02d}_surf_N{N:03d}_p{int(size_of_pixel * 100):04d}{s_part}"]
...
def run_single_combo(args: tuple) -> Tuple[str, dict]:
    ...
    method_config = {
        ...
        "surf_hessian_threshold": combo["surf_hessian_threshold"],
        "surf_n_octaves": combo["surf_n_octaves"],
        "surf_n_octave_layers": combo["surf_n_octave_layers"],
        "surf_extended": combo["surf_extended"],
        "surf_upright": combo["surf_upright"],
        "surf_ratio_threshold": combo["surf_ratio_threshold"],
        "surf_ransac_threshold": combo["surf_ransac_threshold"],
        "surf_ransac_confidence": combo["surf_ransac_confidence"],
    }
    ...
    method = RegistrationFactory.create("surf", method_config)
...
def main():
    ...
    print("=" * 75)
    print("SURF Parameter Sweep Benchmark")
    print("=" * 75)
