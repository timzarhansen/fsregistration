"""
Bremen-MSS Pair Viewer - Automated pair-by-pair registration with image saving

Usage:
    python viewBremenMssPairs.py

Saves display images to viewBremenMssOutput/ folder:
...
from bremenMssDatasetLoader import (
    BremenMSSSequence,
    load_sequence,
...
RADIUS = 22.5                   # Scene radius in meters (pixel_size = 2*radius/N computed automatically)
...
OUTPUT_DIR = "viewBremenMssOutput"  # Blended images saved here
...
def get_config_from_file():
    ...
    global DATA_DIR, SEQUENCE_NUMBER, N, RADIUS, SIZE_OF_PIXEL
    ...
    config_path = os.path.join(source_dir, "viewBremenMssPairs.py")
...
def main():
    ...
    print(f"Loading sequence {seq_name} from {DATA_DIR}...")
