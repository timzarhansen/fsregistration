...
T = np.eye(4)
T[:3, 3] = [0.2, 0, 0]
T[0:3,0:3] = euler_to_rotation_matrix(0,0,0.2)
...
new_pose = register_frame(registration,np.asarray(pcd1.points),np.asarray(pcd2.points),np.eye(4),voxelSize*2,voxelSize,30,1)
print(new_pose)
print("result")
