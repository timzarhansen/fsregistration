...
#ifndef FSREGISTRATION_SOFTCORRELATIONCLASS3D_H
#define FSREGISTRATION_SOFTCORRELATIONCLASS3D_H
...
class softCorrelationClass3D {
public:
    softCorrelationClass3D(int N,int bwOut,int bwIn,int degLim){
        this->N = N;
        this->bwOut = bwOut;
        this->bwIn = bwIn;
        this->degLim = degLim;
...
#endif //FSREGISTRATION_SOFTCORRELATIONCLASS3D_H
