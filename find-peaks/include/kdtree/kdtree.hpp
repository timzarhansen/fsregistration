...
class My4DPoint : public std::array<double, 4>
{
public:
    ...
    // the constructors
    My4DPoint() {}
    My4DPoint(double x, double y,double z, double w,double correlation)
    {
        (*this)[0] = x;//w
        (*this)[1] = y;//x
        (*this)[2] = z;//y
...
//	operator cv::Point4d() const { return cv::Point2d((*this)[0], (*this)[1]); }
};
